...
const sb = createClient(
    'https://bzzoqzqmpxsyrerzthxx.supabase.co',
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ6em9xenFtcHhzeXJlcnp0aHh4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI2NTAxNzMsImV4cCI6MjA4ODIyNjE3M30.AGatDBe1k8-97RfOM7huNav0gnoJDpi9v9cplHTyByM'
)

// Helper: upsert rows and log result
async function seed(table, rows) {
    const { error } = await sb.from(table).upsert(rows, { onConflict: 'id' }).select()
    if (error) {
...
// ── 1. burial_applications ──────────────────────────────────────────
await seed('burial_applications', [
...
await seed('park_reservations', [
    ...
    { reservation_id: 'PR-2024-014', park_id: 'PARK-005', requester_name: 'Kids League QC', requester_contact: '09159012348', event_name: 'Mini Olympics - Kids', event_type: 'sports', event_date: '2024-03-22', start_time: '08:00', end_time: '16:00', expected_guests: 100, area_section: 'Full Park', status: 'rejected', fee_amount: 1000, payment_status: 'unpaid', notes: 'Facility under maintenance' },
])

// ── 5. barangay_facilities ───────────────────────────────────────────
await seed('barangay_facilities', [
    { facility_id: 'FAC-001', facility_name: 'Barangay 123 Multi-Purpose Hall', facility_type: 'hall', capacity: 300, location: 'Ground Floor, Brgy 123 Hall', hourly_rate: 500, status: 'available', amenities: ['Projector', 'Sound System', 'Tables & Chairs', 'AC', 'Kitchen'] },
...
// ── 6. barangay_reservations ─────────────────────────────────────────
await seed('barangay_reservations', [
    { reservation_id: 'BR-2024-030', facility_id: 'FAC-001', requester_name: 'Juan Santos', requester_contact: '09171234000', event_name: 'Santos Family Reunion', event_date: '2024-03-20', start_time: '10:00', end_time: '18:00', expected_guests: 150, purpose: 'Family reunion event', status: 'confirmed', fee_amount: 2500, payment_status: 'paid', approved_by: 'Sec. Maribel Reyes' },
    ...
    { reservation_id: 'BR-2024-022', facility_id: 'FAC-004', requester_name: 'Maabilidad Coop', requester_contact: '09171234010', event_name: 'Handicraft Fair', event_date: '2024-03-28', start_time: '08:00', end_time: '18:00', expected_guests: 70, purpose: 'Livelihood cooperative event', status: 'rejected', fee_amount: 1000, payment_status: 'unpaid' },
])

// ── 7. service_tickets ───────────────────────────────────────────────
await seed('service_tickets', [
    ...
    { ticket_id: 'ST-2024-097', ticket_type: 'general', requester_name: 'Eduardo Marquez', requester_contact: '09104444100', description: 'Inquiry about water bill discrepancy in October statement', location: 'Pasig District Office', priority: 'low', status: 'open' },
    { ticket_id: 'ST-2024-096', ticket_type: 'leak_report', requester_name: 'Christina Moran', requester_contact: '09115555100', description: 'Underground pipe leak detected in alley causing sinkholes', location: 'Brgy. 456 — Alley 7', priority: 'high', status: 'assigned', assigned_to: 'Engr. Cruz Dagatan' },
    ...
    { ticket_id: 'ST-2024-094', ticket_type: 'drainage', requester_name: 'Rosa Garcia', requester_contact: '09137777100', description: 'Drainage overflow during heavy rain affecting 3 households', location: 'Sampaguita St. corner Rosa', priority: 'high', status: 'in_progress', assigned_to: 'Team C' },
    { ticket_id: 'ST-2024-093', ticket_type: 'water_connection', requester_name: 'Aurelio Pascual', requester_contact: '09148888100', description: 'Request for water meter replacement — meter reading inaccurate', location: 'Unit 12, Brgy 789', priority: 'medium', status: 'resolved', assigned_to: 'Team A', resolution_note: 'Meter replaced, new reading calibrated' },
    { ticket_id: 'ST-2024-092', ticket_type: 'leak_report', requester_name: 'Teresita Lim', requester_contact: '09159999100', description: 'Water pressure extremely low for 5 consecutive days', location: 'Block 2 Purok 3', priority: 'medium', status: 'closed', assigned_to: 'Engr. Cruz Dagatan', resolution_note: 'Main valve adjusted, pressure restored' },
    ...
    { ticket_id: 'ST-2024-090', ticket_type: 'water_connection', requester_name: 'Arturo Navarro', requester_contact: '09182000102', description: 'Water service disconnected without notice — urgent restoration', location: 'Brgy Holy Spirit, QC', priority: 'critical', status: 'assigned', assigned_to: 'Engr. Cruz Dagatan' },
])

// ── 8. payment_transactions ──────────────────────────────────────────
await seed('payment_transactions', [
...
// ── 9. constituent_records ───────────────────────────────────────────
await seed('constituent_records', [
...
// ── 10. barangay_ordinances ──────────────────────────────────────────
await seed('barangay_ordinances', [
    { ordinance_id: 'ORD-001', ordinance_no: 'Ord. No. 34 s.2024', title: 'Anti-Noise Pollution Ordinance', description: 'Regulates noise levels in residential and commercial areas from 10PM to 6AM.', category: 'Public Order', date_enacted: '2024-01-15', date_effective: '2024-01-22', status: 'active', enacted_by: 'Capt. Rodrigo Lim' },
    { ordinance_id: 'ORD-002', ordinance_no: 'Ord. No. 33 s.2023', title: 'Solid Waste Segregation Ordinance', description: 'Mandates waste segregation at source for all households and establishments.', category: 'Environment', date_enacted: '2023-09-01', date_effective: '2023-09-15', status: 'active', enacted_by: 'Capt. Rodrigo Lim' },
    { ordinance_id: 'ORD-003', ordinance_no: 'Ord. No. 32 s.2023', title: 'Senior Citizens Welfare Ordinance Amendment', description: 'Amendment expanding benefits to include monthly stipend increase of ₱500.', category: 'Social Welfare', date_enacted: '2023-07-20', date_effective: '2023-08-01', status: 'amended', enacted_by: 'Capt. Rodrigo Lim' },
    ...
    { ordinance_id: 'ORD-005', ordinance_no: 'Ord. No. 30 s.2023', title: 'Anti-Littering and Clean Sidewalk Ordinance', description: 'Prohibits littering and obstruction of sidewalks. Fine of ₱500 to ₱2,000.', category: 'Environment', date_enacted: '2023-03-14', date_effective: '2023-04-01', status: 'active', enacted_by: 'Capt. Rodrigo Lim' },
    { ordinance_id: 'ORD-006', ordinance_no: 'Ord. No. 29 s.2022', title: 'Barangay Health Emergency Response Ordinance', description: 'Establishes protocols for health emergencies and community response.', category: 'Health', date_enacted: '2022-11-20', date_effective: '2022-12-01', status: 'active', enacted_by: 'Capt. Rodrigo Lim' },
    { ordinance_id: 'ORD-007', ordinance_no: 'Ord. No. 28 s.2022', title: 'Senior Citizens Benefits Ordinance', description: 'Provides monthly cash assistance and medicine subsidies for senior citizens.', category: 'Social Welfare', date_enacted: '2022-08-05', date_effective: '2022-09-01', status: 'amended', enacted_by: 'Capt. Rodrigo Lim' },
    { ordinance_id: 'ORD-008', ordinance_no: 'Ord. No. 27 s.2022', title: 'Curfew Ordinance for Minors', description: 'Establishes curfew hours for minors aged below 18: 10PM to 5AM.', category: 'Public Order', date_enacted: '2022-05-01', date_effective: '2022-05-15', status: 'active', enacted_by: 'Capt. Jose Manalac' },
    { ordinance_id: 'ORD-009', ordinance_no: 'Ord. No. 26 s.2021', title: 'Anti-Stray Animals Ordinance', description: 'Requires all pet owners to register their animals and prohibits free-roaming.', category: 'Public Order', date_enacted: '2021-12-10', date_effective: '2022-01-01', status: 'active', enacted_by: 'Capt. Jose Manalac' },
    { ordinance_id: 'ORD-010', ordinance_no: 'Ord. No. 25 s.2021', title: 'Community Vegetable Garden Program', description: 'Requires households with open space to maintain a 2x2m vegetable garden.', category: 'Environment', date_enacted: '2021-07-15', date_effective: '2021-08-01', status: 'repealed', enacted_by: 'Capt. Jose Manalac' },
])

// ── 11. barangay_documents ───────────────────────────────────────────
await seed('barangay_documents', [
    ...
    { document_id: 'DOC-005', document_no: 'PER-0045', document_type: 'permit', title: 'Permit to Renovate — Blk 5 Lot 3', issued_to: 'Pedro Bautista', purpose: 'Renovation permit application', status: 'filed', issued_by: 'Sec. Maribel Reyes', document_date: '2024-03-04' },
    { document_id: 'DOC-006', document_no: 'MEMO-019', document_type: 'memo', title: 'Memorandum on Prohibited Burning of Garbage', issued_to: 'All Purok Leaders', purpose: 'Directive on DENR compliance', status: 'filed', issued_by: 'Sec. Maribel Reyes', document_date: '2024-03-03' },
    { document_id: 'DOC-007', document_no: 'LTR-008', document_type: 'letter', title: 'Letter to DSWD Re: Indigent Assistance Funding', issued_to: 'DSWD QC Division', purpose: 'Official request for funding', status: 'draft', issued_by: 'Sec. Maribel Reyes', document_date: '2024-03-02' },
    ...
    { document_id: 'DOC-010', document_no: 'LTR-007', document_type: 'letter', title: 'Letter of Recommendation — Scholarship', issued_to: 'QC Science High School', purpose: 'Scholarship application endorsement', status: 'released', issued_by: 'Sec. Maribel Reyes', document_date: '2024-02-25' },
    { document_id: 'DOC-011', document_no: 'CERT-0285', document_type: 'clearance', title: 'Barangay Clearance', issued_to: 'Eduardo Ramos', purpose: 'For driver license renewal', status: 'released', issued_by: 'Sec. Maribel Reyes', document_date: '2024-02-24' },
    { document_id: 'DOC-012', document_no: 'RES-021-2024', document_type: 'resolution', title: 'Resolution Approving Community Hall Reservation', issued_to: 'N/A', purpose: 'For official record keeping', status: 'filed', issued_by: 'Sec. Maribel Reyes', document_date: '2024-03-05' },
])

// ── 12. asset_inventory ──────────────────────────────────────────────
await seed('asset_inventory', [
    ...
    { asset_id: 'ASSET-006', asset_name: 'CCTV Camera System — 16ch', asset_type: 'it_equipment', category: 'Security Equipment', serial_no: 'CCTV-16CH-001', acquisition_date: '2023-01-15', acquisition_cost: 180000, current_value: 165000, condition: 'excellent', location: 'Security Office', assigned_to: 'IT Department' },
    ...
    { asset_id: 'ASSET-009', asset_name: 'Grass Cutter — Ride-On', asset_type: 'equipment', category: 'Grounds Equipment', serial_no: 'GC-TORO-001', acquisition_date: '2021-08-15', acquisition_cost: 98000, current_value: 72000, condition: 'fair', location: 'Parks Storage', assigned_to: 'Parks Division', last_maintenance: '2023-12-01' },
...
await seed('notifications', [
    ...
    { notif_id: 'NOTIF-002', user_role: 'barangay_secretary', title: 'Reservation Confirmed', message: 'Facility reservation BR-2024-030 for Juan Santos has been confirmed.', type: 'success', is_read: false, link_path: '/barangay/reservations' },
    { notif_id: 'NOTIF-003', user_role: 'utility_engineer', title: 'Critical Ticket Assigned', message: 'Ticket ST-2024-099 (Major pipe burst) — CRITICAL PRIORITY.', type: 'error', is_read: false, link_path: '/utility/tickets' },
    { notif_id: 'NOTIF-004', user_role: 'treasurer', title: 'Pending Reconciliation', message: '3 transactions await reconciliation: TXN-2024-548, TXN-2024-542, TXN-2024-538.', type: 'warning', is_read: false, link_path: '/treasurer/transactions' },
    { notif_id: 'NOTIF-005', user_role: 'parks_admin', title: 'New Park Reservation', message: 'Park reservation PR-2024-016 (Wedding Reception) pending approval.', type: 'info', is_read: false, link_path: '/parks/reservations' },
    { notif_id: 'NOTIF-006', user_role: 'barangay_secretary', title: 'Document Requested', message: 'Certificate of Residency requested by Maria Dela Cruz — CERT-0288.', type: 'info', is_read: false, link_path: '/barangay/documents' },
    { notif_id: 'NOTIF-007', user_role: 'punong_barangay', title: 'Ordinance Review Required', message: 'Ord. No. 33 s.2023 scheduled for annual review this week.', type: 'warning', is_read: false, link_path: '/barangay/ordinances' },
...
console.log('\n🎉 All done! BPM Supabase database seeded successfully.')
