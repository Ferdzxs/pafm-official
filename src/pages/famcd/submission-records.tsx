...
export default function Submissions() {
    ...
    return (
        <AdminDeskPageShell
            ...
            description="Incoming asset requests from operational units and formal report submissions to CGSD."
            wide
            actions={
                <Button variant="outline" size="sm" className="gap-2" type="button" onClick={reload}>
