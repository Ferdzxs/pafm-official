    ...
    <div className="px-4 py-4 sm:px-6 lg:px-8 max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">Program performance and constituent service delivery metrics</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {kpis.map(({ label, value, icon: Icon, color, change }) => (
          <Card key={label} className="card-hover bg-slate-900/40 border-slate-800/50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Bar Chart */}
        <Card className="lg:col-span-2 bg-slate-900/40 border-slate-800/50">
          ...
          <CardContent>
            <div className="h-[220px] flex items-end gap-2 pb-4 border-b border-slate-800/50">
                ...
                return (
                  <div key={i} className="flex-1 group relative flex flex-col items-center gap-1">
                    <div
                      ...
                      style={{ height: `${pct}%` }}
                    >
                      <div className="absolute -top-5 left-1/2 -translate-x-1/2 text-[9px] font-bold text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                        {h}
                      </div>
                    </div>
      ...
      {/* Verification Funnel */}
      <Card className="bg-slate-900/40 border-slate-800/50 mt-6">
        <CardHeader className="pb-2">
            ...
            {[
              ...
              return (
                <div key={label} className="flex-1 flex flex-col items-center gap-2">
                  ...
                  />
                  <div className="text-[10px] text-slate-400 font-bold text-center">{label}</div>
                </div>
              )
            })}
          </div>
