...
const MOCK_REQUESTS = [
  ...
  {
    id: "REQ-BR-003",
    item: "Barangay Hall Aircon Cleaning",
    status: "Approved",
    date: "2023-10-25",
    priority: "Low",
  },
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          >
            Submit and track maintenance or resource requests to CGSD/FAMCD for
            the Barangay.
          </p>
        </div>
        <button
      ...
      {/* FILTERS & SEARCH */}
      <div
        className="flex flex-col sm:flex-row items-center gap-3 p-2 rounded-2xl"
        style={{
          background: "var(--color-card)",
          border: "1px solid var(--color-border)",
        }}
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/20">
                <th className="px-6 py-4 font-semibold text-gray-500 dark:text-gray-400">
                  Request ID
                </th>
                <th className="px-6 py-4 font-semibold text-gray-500 dark:text-gray-400">
                  Item / Service
