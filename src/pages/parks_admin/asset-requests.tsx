...
export default function ParksAssetRequestsPage() {
    ...
    return (
        <>
        <div className="asset-requests-page">
            {/* HEADER */}
            <div className="asset-requests-header">
                <div>
                    <h1 className="asset-requests-title">
            ...
            {/* STATS */}
            <div className="asset-requests-stats">
                {[
            ...
            {/* SEARCH */}
            <div className="asset-requests-search">
            ...
            {/* TABLE */}
            <div className="asset-requests-table">
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm whitespace-nowrap">
                        <thead>
                            <tr className="border-b border-gray-100 dark:border-gray-800 bg-#f1f5f9 dark:bg-#f1f5f9">
        ...
        {/* NEW REQUEST DIALOG (premium card) */}
            ...
            <DialogPremiumInner>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: 'var(--color-text-muted)' }}>Submitting to FAMCD — Parks Admin</p>
                </div>
              </div>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Park Benches (x5), Replacement Lighting Fixtures"
                                    value={formItem}
