/**
 * Parks Admin — Asset & resource requests (light/dark + premium dialog)
 */
          ...
          <div className="card-premium sidebar-scrollbar mx-auto max-h-[90vh] w-full animate-in zoom-in-95 duration-300 overflow-y-auto p-6 sm:p-8">
            <DialogHeader className="space-y-3 text-left">
              ...
              <DialogDescription className="font-medium text-muted-foreground">
                Submitting to FAMCD — Parks Admin
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="pk-item" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Item / service requested *
                </Label>
                <Input
                  id="pk-item"
                  required
                  placeholder="e.g. Park benches, replacement lighting fixtures"
                  value={formItem}
              ...
              <div className="space-y-2">
                <Label htmlFor="pk-prop" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Target property *
                </Label>
                <select
                  id="pk-prop"
              ...
              <div className="space-y-2">
                <Label htmlFor="pk-pri" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Priority
                </Label>
                <select
                  id="pk-pri"
              ...
              <div className="space-y-2">
                <Label htmlFor="pk-notes" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Notes (optional)
                </Label>
                <Textarea
                  id="pk-notes"
