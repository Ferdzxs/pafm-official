...
export default function ParksAssetRequestsPage() {
    ...
    return (
        ...
        <AdminDeskPageShell
            ...
            description="Submit and track maintenance or resource requests sent to FAMCD (Parks & Recreation)."
            wide
            actions={
                <>
                    <button
                    ...
                    <DialogHeader className="mb-6">
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest bg-primary/10 text-primary border border-primary/20">Parks Admin</span>
                            </div>
                        ...
                        <DialogDescription className="font-medium text-muted-foreground/80 mt-1">
                            Submitting to FAMCD - Parks administration workflow.
                        </DialogDescription>
                    </DialogHeader>
