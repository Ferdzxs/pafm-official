...
// Mock Data
const MOCK_REQUESTS = [
    { id: 'REQ-PK-001', item: 'Park Benches (x5)', status: 'Approved', date: '2023-11-02', priority: 'Medium' },
    { id: 'REQ-PK-002', item: 'Replacement Lighting Fixtures', status: 'In Progress', date: '2023-10-30', priority: 'High' },
    { id: 'REQ-PK-003', item: 'Trash Bins (x10)', status: 'Pending', date: '2023-10-28', priority: 'Low' },
]
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm mt-1" style={{ color: 'var(--color-text-muted)' }}>
                        Submit and track maintenance or resource requests to CGSD/FAMCD for Park Facilities.
                    </p>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                    { label: 'Pending Requests', value: 1, icon: Clock, color: '#f59e0b' },
                    { label: 'Approved', value: 8, icon: CheckCircle, color: '#10b981' },
