...
import { TrendingUp, TrendingDown, Clock, CheckCircle, CreditCard, AlertTriangle } from 'lucide-react'
import {
...
const CHART_DATA = [
    { date: 'Feb 27', amount: 89500 },
    { date: 'Feb 28', amount: 112000 },
    { date: 'Mar 1', amount: 95000 },
    { date: 'Mar 2', amount: 134000 },
    { date: 'Mar 3', amount: 108000 },
    { date: 'Mar 4', amount: 124500 },
]

const QUICK_ACTIONS = [
    { label: 'Reconciliation Queue', emoji: '🔄', path: '/treasurer/reconciliation' },
    { label: 'Issue Official Receipt', emoji: '🧾', path: '/treasurer/receipts' },
]
                            ...
                            <ResponsiveContainer width="100%" height={160}>
                                <BarChart data={CHART_DATA}>
                                    ...
                                    <Tooltip
                                        ...
                                        formatter={(v) => [`₱${(v ?? 0).toLocaleString()}`, 'Amount']}
                                    />
