      ...
      <div className="card-premium mx-auto w-full animate-in zoom-in-95 duration-300 max-h-[90vh] flex flex-col sidebar-scrollbar">
       <DialogHeader className="mb-6 space-y-1 text-left shrink-0">
        <div className="flex items-center gap-2 mb-2">
         <Badge variant="outline" className="text-[10px] font-bold tracking-widest border-border bg-background">USER ID: {managingUser.user_id}</Badge>
        </div>
        ...
        <div className="grid grid-cols-1 gap-y-4 text-sm surface-box border border-border/20 p-5">
         ...
         <div className="space-y-1.5 pt-4 border-t border-border/10">
          ...
          <p className="text-[10px] text-muted-foreground italic mt-1 ml-1">
           Update credentials only if requested by the user.
          </p>
         </div>
        </div>
       </div>
       ...
       <div className="mt-8 pt-6 border-t border-border/10 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-3 shrink-0">
        ...
        <button
         className="h-11 rounded-xl px-8 w-full sm:w-auto bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 text-[11px] font-extrabold uppercase tracking-widest disabled:opacity-50 transition-all"
