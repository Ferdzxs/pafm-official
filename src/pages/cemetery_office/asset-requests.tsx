...
// Mock Data
const MOCK_REQUESTS = [
    { id: 'REQ-CM-001', item: 'Lawnmower Parts', status: 'Pending', date: '2023-10-25', priority: 'Medium' },
    { id: 'REQ-CM-002', item: 'Fertilizer (50kg)', status: 'Approved', date: '2023-10-20', priority: 'Low' },
    { id: 'REQ-CM-003', item: 'Grave Digging Equipment Maintenance', status: 'In Progress', date: '2023-10-18', priority: 'High' },
]
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm mt-1" style={{ color: 'var(--color-text-muted)' }}>
                        Submit and track maintenance or resource requests to CGSD/FAMCD for the Cemetery Office.
                    </p>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                    { label: 'Pending Requests', value: 3, icon: Clock, color: '#f59e0b' },
                    { label: 'Approved', value: 12, icon: CheckCircle, color: '#10b981' },
                    { label: 'Rejected', value: 1, icon: XCircle, color: '#ef4444' },
                ].map((stat, i) => {
