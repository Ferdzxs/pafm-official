/**
 * Cemetery Office — Asset & resource requests (light/dark + premium dialog)
 */
          ...
          <div className="card-premium sidebar-scrollbar mx-auto max-h-[90vh] w-full animate-in zoom-in-95 duration-300 overflow-y-auto p-6 sm:p-8">
            <DialogHeader className="space-y-3 text-left">
              ...
              <DialogDescription className="font-medium text-muted-foreground">
                Submitting to FAMCD — Cemetery Office
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="co-item" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
              ...
              <div className="space-y-2">
                <Label htmlFor="co-prop" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Target property *
                </Label>
                <select
                  id="co-prop"
              ...
              <div className="space-y-2">
                <Label htmlFor="co-pri" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Priority
                </Label>
                <select
                  id="co-pri"
              ...
              <div className="space-y-2">
                <Label htmlFor="co-notes" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                  Notes (optional)
                </Label>
                <Textarea
                  id="co-notes"
