            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="w-full max-w-md rounded-2xl shadow-xl p-6 space-y-5" style={{ background: 'var(--color-card)', border: '1px solid var(--color-border)' }}>
                        <div className="flex justify-between items-center">
                            ...
                            <button onClick={() => setShowModal(false)} className="p-1 rounded-lg hover:bg-black/10 dark:hover:bg-white/10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                <label className="text-xs font-semibold block mb-2" style={{ color: 'var(--color-text-muted)' }}>Supporting Documents <span className="font-normal">(Request Letter optional; RA-16 and NR-15 required)</span></label>
