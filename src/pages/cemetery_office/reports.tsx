  ...
  <div className="px-4 py-4 sm:px-6 lg:px-8 animate-fade-in text-white">
   <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
    <div>
     ...
     <p className="text-muted-foreground text-sm mt-0.5">Real-time cemetery analytics and data exports</p>
    </div>
   ...
   {loading ? (
    <div className="py-40 flex flex-col items-center justify-center text-muted-foreground gap-4">
