  ...
  return (
    <Routes>
      ...
      >
        ...
        />
        <Route
          path="burial/deceased"
          element={
            <PlaceholderPage
              title="Deceased Registry"
              description="Full deceased registry with search across all records."
            />
          }
        />
        ...
        <Route
          ...
          element={
            <PlaceholderPage
              ...
              description="Complete burial record ledger with filtering and export."
            />
          }
        />
        <Route
          path="burial/indigent"
          element={
            <PlaceholderPage
              title="Indigent Assistance"
              description="Indigent assistance case management portal."
            />
          }
        />
        <Route
        ...
        <Route
          path="ssdd/indigent"
          element={<PlaceholderPage title="Indigent Assistance Cases" />}
        />
        <Route
          path="ssdd/citizens"
          element={<PlaceholderPage title="Citizen Records" />}
        />
        <Route
          path="ssdd/coordination"
          element={<PlaceholderPage title="Death Registration Coordination" />}
        />

        {/* ── Death Registration ── */}
        <Route
          path="death/verify"
          element={<PlaceholderPage title="Certificate Verification" />}
        />
        <Route
          path="death/documents"
          element={<PlaceholderPage title="Received Documents" />}
        />
        <Route
          path="death/approvals"
          element={<PlaceholderPage title="Approvals & Signing" />}
        />
        ...
        <Route
          ...
          element={<PlaceholderPage title="Apply: Park Reservation" />}
        />
        <Route
        ...
        <Route
          path="parks/venues"
          element={<PlaceholderPage title="Park Venues" />}
        />
        <Route
          path="parks/reservations"
          element={<PlaceholderPage title="Park Reservation Applications" />}
        />
        <Route
          path="parks/usage-logs"
          element={<PlaceholderPage title="Site Usage Logs" />}
        />
        <Route
          path="parks/calendar"
          element={<PlaceholderPage title="Booking Calendar" />}
        />
        <Route
        ...
        <Route
          ...
          element={<PlaceholderPage title="Inventory & Assets" />}
        />
        <Route
          path="assets/inspections"
          element={<PlaceholderPage title="Ocular Inspections" />}
        />
        <Route
          path="assets/reports"
          element={<PlaceholderPage title="Inventory Reports" />}
        />
        <Route
          path="assets/approvals"
          element={<PlaceholderPage title="Approval Records" />}
        />
        <Route
          path="assets/submissions"
          element={<PlaceholderPage title="Submission Records" />}
        />
